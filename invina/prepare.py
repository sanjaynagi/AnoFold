...
from .utils import vectorbase_to_uniprot, get_uniprot_data, pdb_to_pandas, amino_acid_map
...
def pdb_to_active_site_coords(receptor_path, active_site_motif, catalytic_codon_in_motif, catalytic_molecule, flanking_size=5):
    ...
    for match in motif_matches:
        ...
        coords = df_pdb.query(f"residue_number == {target_idx} and atom_name == '{catalytic_molecule}'")
